...
<head>
	...
	<script src="http://vr360.globalvision.ch/assets/krpano/1.19/tour.js"></script>
</head>
<body>
...
<div id="pano" style="width: 100%; height: 100%;">
	...
	<script type="text/javascript">
		embedpano({
			...
			xml: "http://vr360.globalvision.ch/_/<?php echo $vt; ?>/vtour/tour.xml?" + Math.round(Math.random() * 1000000000).toString(),
			target: "pano",
			html5: "prefer",
